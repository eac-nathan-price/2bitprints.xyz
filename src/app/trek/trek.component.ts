...
export class TrekComponent implements OnInit {
  ...
  fonts: FontOption[] = [
    ...
    { name: 'FederationWide', value: 'FederationWide', displayName: 'Federation Wide', category: 'Federation' },
    ...
    { name: 'TrekTNGMonitors', value: 'TrekTNGMonitors', displayName: 'TNG Monitors', category: 'TNG' },
    ...
    { name: 'FinalFrontier', value: 'FinalFrontier', displayName: 'Final Frontier', category: 'Movies' },
    ...
    { name: 'ContextUltraCondensed', value: 'ContextUltraCondensed', displayName: 'Context Ultra Condensed', category: 'Technical' },
    { name: 'ContextUltraCondensedBold', value: 'ContextUltraCondensedBold', displayName: 'Context Ultra Condensed Bold', category: 'Technical' },
    ...
    { name: 'NovaLightUltra', value: 'NovaLightUltra', displayName: 'Nova Light Ultra', category: 'Additional' },
    { name: 'NovaLightUltraThin', value: 'NovaLightUltraThin', displayName: 'Nova Light Ultra Thin', category: 'Additional' },
  ...
  get groupedFonts() {
    const groups = this.fonts.reduce((acc, font) => {
