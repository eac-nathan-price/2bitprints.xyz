...
.logo-container {
  ...
  &:hover {
    .red {
      transform: rotateZ(90deg) translateX(-4px) translateY(4px) translateZ(30px);
    }
    
    .green {
      transform: rotateX(90deg) translateZ(-62px) translateX(-62px) translateZ(30px);
    }
    
    .blue {
      transform: rotateY(-90deg) translateY(-4px) translateX(2px) translateZ(30px);
    }
  }
}
